...
CREATE TABLE `testimoniales` (
  ...
  `nombre` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `correo` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `mensaje` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin,
  PRIMARY KEY (`id`)
...
INSERT INTO `testimoniales` VALUES (1,'Sarah Williams 2','purplehat189@gmail.com','La mejor pagina'),(2,'Sebastian Castillo','asd@asd.com','Precio brutales :D'),(10,'Eder Benites','gbp17@outlook.com','Los aviones están cheveres');
...
-- Dump completed on 2024-01-17 18:02:47
